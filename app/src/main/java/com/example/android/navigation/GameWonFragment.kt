...
class GameWonFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        if (null == getShareIntent().resolveActivity(activity!!.packageManager)) {
            // hides the menu item if it doesn't resolve
...
//        shareIntent.setType("text/plain").putExtra(Intent.EXTRA_TEXT, getString(
//                R.string.share_success_text, args.numCorrect, args.numQuestions)
//        )
//        return shareIntent
        return ShareCompat.IntentBuilder.from(activity).setText(
                getString(R.string.share_success_text, args.numCorrect, args.numQuestions)).setType("text/plain").intent
    }
